...
- Python 3.14+
- **Node.js ≥ 20.19** или **≥ 22.12** (LTS) — только для сборки кастомного компонента  

Проверка: `node -v` (нужно `v20.19.x`, `v22.12.x+` или `v24+`).
...
Между шпаргалкой (подсказки по директивам) и вкладками — текст состояния сохранения.

### Панель «Конфигурация»

По умолчанию свёрнута. Открыть: ручка на левом краю экрана.
